...
<section id="sit_rel">
    ...
    $sql = " select b.* from {$g5['g5_shop_item_relation_table']} a left join {$g5['g5_shop_item_table']} b on (a.it_id2=b.it_id) where a.it_id = '{$it['it_id']}' and b.it_use='1' and a.site_id = '$site_id' and b.site_id ='$site_id' ";
...
<!-- 배송갤러리 시작 { -->
<section id="sit_gallery">
    <h2>배송사진</h2>
    <?php echo pg_anchor('delivery'); ?>

    <div id="itemgallery"><?php include_once(G5_SHOP_PATH.'/delivery_gallery.php'); ?></div>
</section>
<!-- } 배송갤러리 끝  -->
