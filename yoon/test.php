...
$ribbon = get_ribbon(2018053012241018);

$info = get_order(2018053012241018);
...
foreach($ribbon as $cti) {
    ...
    $data = array(
        ...
        "msg_type" => $msg_type,
        "ribbon_msg_0" => $ribbon_msg_1,
        "ribbon_msg_1" => $ribbon_msg_0,
        "card_msg" => $card_msg,
        "email" => $email,
...
/*
    ...
    if ($result['success']) {
        ...
        cti_response_insert($result['success'], $result['message'], $cti['od_id'], $cti['it_id'], $cti['it_name'], $cti['ct_qty'], $cti['rb_no'], $extra_item_cost, $cost);
