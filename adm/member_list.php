...
$sql = " select count(*) as cnt {$sql_common} {$sql_search} and site_id = '{$site_id}' {$sql_order} ";
$row = sql_fetch($sql);
$total_count = $row['cnt'];
...
// 탈퇴회원수
$sql = " select count(*) as cnt {$sql_common} {$sql_search} and mb_leave_date <> '' and site_id = '{$site_id}' {$sql_order} ";
$row = sql_fetch($sql);
$leave_count = $row['cnt'];

// 차단회원수
$sql = " select count(*) as cnt {$sql_common} {$sql_search} and mb_intercept_date <> '' and site_id = '{$site_id}' {$sql_order} ";
$row = sql_fetch($sql);
...
$sql = " select * {$sql_common} {$sql_search} and site_id = '{$site_id}' {$sql_order} limit {$from_record}, {$rows} ";
