...
{
    $sql = " update {$g5['faq_master_table']} $sql_common where fm_id = '$fm_id' and site_id = '$site_id' ";
    sql_query($sql);
}
else if ($w == "d")
{
    ...
    // FAQ삭제
	$sql = " delete from {$g5['faq_master_table']} where fm_id = '$fm_id' and site_id = '$site_id' ";
    sql_query($sql);

    // FAQ상세삭제
	$sql = " delete from {$g5['faq_table']} where fm_id = '$fm_id' and site_id = '$site_id' ";
    sql_query($sql);
}
