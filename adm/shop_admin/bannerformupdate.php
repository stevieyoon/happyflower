...
else if ($w=="u")
{
    $sql = " update {$g5['g5_shop_banner_table']}
                set bn_alt        = '$bn_alt',
                    ...
                    bn_end_time   = '$bn_end_time',
                    bn_order      = '$bn_order'
              where bn_id = '$bn_id' and site_id = '$site_id' ";
    sql_query($sql);
}
else if ($w=="d")
{
    ...
    $sql = " delete from {$g5['g5_shop_banner_table']} where bn_id = $bn_id and site_id = '$site_id' ";
...
if ($w == "" || $w == "u")
{
    ...
    goto_url("./bannerform.php?w=u&amp;bn_id=$bn_id&amp;site_id=$site_id");
} else {
