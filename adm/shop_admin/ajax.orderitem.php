...
<section id="cart_list">
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        for($i=0; $row=sql_fetch_array($result); $i++) {
            ...
            // 상품의 옵션정보
            $sql = " select ct_id, it_id, ct_price, ct_qty, ct_option, ct_status, cp_price, ct_send_cost, io_type, io_price, order_no
                        from {$g5['g5_shop_cart_table']}
                        where od_id = '$od_id'
                          and it_id = '{$row['it_id']}'
            ...
            <tr>
                ...
                <td class="td_itname" rowspan="<?php echo $rowspan; ?>">
                    ...
                    <?php if($od['od_tax_flag'] && $row['ct_notax']) echo '[비과세상품]'; ?> - [<?php echo $opt['order_no'] ?>]
                </td>
                <?php } ?>
