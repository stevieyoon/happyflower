...
$sql_common = " from {$g5['g5_shop_item_table']} a
                left join {$g5['g5_shop_event_item_table']} b on (a.it_id=b.it_id and b.ev_id='$ev_id') where a.site_id = '$site_id' ";
...
// 이벤트제목
if($ev_id) {
    $tmp = sql_fetch(" select ev_subject from {$g5['g5_shop_event_table']} where ev_id = '$ev_id' and site_id = '$site_id' ");
...
<select name="ev_id" id="ev_id" action="<?php echo $_SERVER['SCRIPT_NAME']; ?>">
    ...
    $sql1 = " select ev_id, ev_subject from {$g5['g5_shop_event_table']} where site_id = '$site_id' order by ev_id desc ";
...
<select name="sel_ca_id" id="sel_ca_id">
    ...
    <?php
    $sql1 = " select ca_id, ca_name from {$g5['g5_shop_category_table']} where site_id = '$site_id' order by ca_order, ca_id ";
    $result1 = sql_query($sql1);
