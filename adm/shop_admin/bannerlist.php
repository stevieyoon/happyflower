...
$sql_common = " from {$g5['g5_shop_banner_table']} where site_id = '$site_id' ";
...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        ...
        <th scope="col" id="th_dvc">등록 사이트</th>
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td headers="th_mng" class="td_mng td_mns_m">
            <a href="./bannerform.php?w=u&amp;bn_id=<?php echo $row['bn_id']; ?>&amp;site_id=<?php echo $row['site_id']; ?>" class="btn btn_03">수정</a>
            <a href="./bannerformupdate.php?w=d&amp;bn_id=<?php echo $row['bn_id']; ?>&amp;site_id=<?php echo $row['site_id']; ?>" onclick="return delete_confirm(this);" class="btn btn_02">삭제</a>
        </td>
    </tr>
    <tr class="<?php echo $bg; ?>">
        <td headers="th_img" colspan="9" class="td_img_view sbn_img">
