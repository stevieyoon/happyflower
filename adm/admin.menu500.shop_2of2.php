...
$menu['menu500'] = array (
    ...
    array('500800', '현재접속자', G5_ADMIN_URL.'/shop_admin/current_connect.php', 'current_connect'),
    array('500900', '검색유입 통계', G5_ADMIN_URL.'/shop_admin/visite_engine.php', 'visite_engine'),
);
?>