...
if(!isset($config['cf_cert_use'])) {
    ...
    sql_query(" update {$g5['member_table']} set mb_certify = 'hp' where mb_certify = '1' where site_id = '$site_id' ");
    sql_query(" update {$g5['member_table']} set mb_certify = '' where mb_certify = '0' where site_id = '$site_id' ");
