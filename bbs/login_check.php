...
if($config['cf_use_point']) {
    ...
    $sql= " update {$g5['member_table']} set mb_point = '$sum_point' where mb_id = '{$mb['mb_id']}' and site_id = '{$site_id}' ";
    sql_query($sql);
}
...
if(function_exists('set_cart_id')){
    ...
    // 선택필드 초기화
    $sql = " update {$g5['g5_shop_cart_table']} set ct_select = '0' where od_id = '$s_cart_id' and site_id = '{$site_id}' ";
    sql_query($sql);
}
