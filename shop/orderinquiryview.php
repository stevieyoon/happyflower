                ...
                <tr>
                    ...
                    <td>
                        ...
                        if($od['od_settle_case'] == '휴대폰')
                        {
                            ...
                            } else if($od['od_pg'] == 'mainpay') { // wetoz : mainpay
                        ...
                        if($od['od_settle_case'] == '신용카드' || is_inicis_order_pay($od['od_settle_case']) )
                        {
                            if($od['od_pg'] == 'lg') {
                                ...
                                $card_receipt_script = 'window.open(\''.$mpay_receipt_card_url.'?ref_no='.$od['od_tno'].'&tran_date='.str_replace('-', '', substr($od['od_receipt_time'], 2, 8)).'\', \'winreceipt\', \'width=800,height=815,scrollbars=yes,resizable=yes\');';
                            } else {
            ...
            <div class="tbl_head01 tbl_wrap">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php
                        // 희망배송일을 사용한다면
                        if ($od['od_hope_date'] == '0000-00-00') {
                            echo '즉시배송';
                        } else {
                            echo substr($od['od_hope_date'],0,10).' ('.get_yoil($od['od_hope_date']).') : '.$od['od_hope_time'] ;
                        }
                        ?>
                        </span>
                    </td>
