...
{
    $sql = " update {$g5['new_win_table']} set $sql_common where nw_id = '$nw_id' and site_id = '$site_id' ";
    sql_query($sql);
}
else if ($w == "d")
{
    $sql = " delete from {$g5['new_win_table']} where nw_id = '$nw_id' and site_id = '$site_id' ";
    sql_query($sql);
}
