...
$sql_common = " from {$g5['g5_shop_event_table']} where site_id = '$site_id' ";
...
<div class="tbl_head01 tbl_wrap">
    ...
    for ($i=0; $row=sql_fetch_array($result); $i++) {
        ...
        $href = "";
        $sql = " select count(ev_id) as cnt from {$g5['g5_shop_event_item_table']} where ev_id = '{$row['ev_id']}' and site_id = '$site_id' ";
        $ev = sql_fetch($sql);
        if ($ev['cnt']) {
