...
<section id ="anc_scf_payment">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td>
                <?php echo help("관리자는 설정에 관계없이 <a href=\"".G5_MASTER_URL."/shop_admin/orderlist.php\">주문내역</a> &gt; 보기에서 발급이 가능합니다.\n현금영수증 발급 취소는 PG사에서 지원하는 현금영수증 취소 기능을 사용하시기 바랍니다.", 50); ?>
        ...
        <tr>
            ...
            <td>
                <?php echo help("<a href=\"".G5_MASTER_URL."/config_form.php#frm_board\" target=\"_blank\">환경설정 &gt; 기본환경설정</a>과 동일한 설정입니다."); ?>
        ...
        <tr>
            ...
            <td>
                ...
                <ul class="de_pg_tab">
                    ...
                    <li class="<?php if($default['de_pg_service'] == 'mainpay') echo 'tab-current'; ?>"><a href="#mainpay_info_anchor" data-value="mainpay" title="메인페이 선택하기">메인페이</a></li>
                </ul>
            </td>
        </tr>
        <tr class="pg_info_fld mainpay_info_fld" id="mainpay_info_anchor">
            <th scope="row">
                <label for="de_mainpay_mid">MAINPAY ID</label><br>
                <a href="http://biz.mainpay.co.kr" target="_blank" id="scf_mainpayreg" class="mainpay_btn">메인페이 서비스신청하기</a>
            </th>
            <td>
                <?php echo help("메인페이 아이디 6자리"); ?>
                <input type="text" name="de_mainpay_mid" value="<?php echo $default['de_mainpay_mid']; ?>" id="de_mainpay_mid" class="frm_input" size="6" maxlength="6" style="font:bold 15px Verdana;">
            </td>
        </tr>
        <tr class="pg_info_fld mainpay_info_fld">
            <th scope="row"><label for="de_mainpay_key">MAINPAY SITE KEY</label></th>
            <td>
                <?php echo help("전화: 02-6925-2020\n예) U1FVQVJFDDDFSFSDwMTU3OTIwMTcxMTAFDSFDSA"); ?>
                <input type="text" name="de_mainpay_key" value="<?php echo $default['de_mainpay_key']; ?>" id="de_mainpay_key" class="frm_input" size="50" maxlength="50">
                <input type="hidden" name="de_cpcode" id="de_cpcode" value="<?php echo $default['de_cpcode'];?>" />
            </td>
        </tr>
...
<section id="anc_scf_sms" >
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td>
                <?php echo help("SMS  서비스 회사를 선택하십시오. 서비스 회사를 선택하지 않으면, SMS 발송 기능이 동작하지 않습니다.<br>아이코드는 무료 문자메세지 발송 테스트 환경을 지원합니다.<br><a href=\"".G5_MASTER_URL."/config_form.php#anc_cf_sms\">기본환경설정 &gt; SMS</a> 설정과 동일합니다."); ?>
