...
if ($w == "")
{
    ...
    if (!$it['ca_id'])
    {
        $sql = " select ca_id from {$g5['g5_shop_category_table']} where site_id = '$site_id' order by ca_order, ca_id limit 1 ";
        $row = sql_fetch($sql);
        if (!$row['ca_id'])
...
else if ($w == "u")
{
    ...
    $sql = " select * from {$g5['g5_shop_category_table']} where ca_id = '$ca_id' and site_id = '$site_id' ";
    $ca = sql_fetch($sql);
}
else
{
...
$category_select = '';
$script = '';
$sql = " select * from {$g5['g5_shop_category_table']} where site_id = '$site_id' ";
if ($is_admin != 'super')
        ...
        <tr>
            ...
            <td colspan="2">
                ...
                <?php } else { ?>
                    ...
                    <a href="<?php echo G5_MASTER_URL; ?>/shop_admin/itemuselist.php?sfl=a.it_id&amp;stx=<?php echo $it_id; ?>" class="btn_frmline">사용후기</a>
                    <a href="<?php echo G5_MASTER_URL; ?>/shop_admin/itemqalist.php?sfl=a.it_id&amp;stx=<?php echo $it_id; ?>" class="btn_frmline">상품문의</a>
                <?php } ?>
            </td>
        </tr>
        <tr>
...
<section id="anc_sitfrm_compact">
    ...
    <div id="sit_compact">
        ...
        <select id="it_info_gubun" name="it_info_gubun">
            ...
            <?php
            if(!$it['it_info_gubun']) $it['it_info_gubun'] = 'flower';
    ...
    <div id="sit_compact_fields"><?php include_once(G5_MASTER_PATH.'/shop_admin/iteminfo.php'); ?></div>
</section>
...
$(function(){
    $(document).on("change", "#it_info_gubun", function() {
        var gubun = $(this).val();
        $.post(
            "<?php echo G5_MASTER_URL; ?>/shop_admin/iteminfo.php",
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td colspan="2">
                ...
                <div id="sit_option_frm"><?php include_once(G5_MASTER_PATH.'/shop_admin/itemoption.php'); ?></div>
                ...
                $(function() {
                    ...
                    $("#option_table_create").click(function() {
                        ...
                        $.post(
                            "<?php echo G5_MASTER_URL; ?>/shop_admin/itemoption.php",
        ...
        <tr>
            ...
            <td colspan="2">
                ...
                <div id="sit_option_addfrm"><?php include_once(G5_MASTER_PATH.'/shop_admin/itemsupply.php'); ?></div>
                ...
                $(function() {
                    ...
                    $("#supply_table_create").click(function() {
                        ...
                        $.post(
                            "<?php echo G5_MASTER_URL; ?>/shop_admin/itemsupply.php",
    ...
    <div class="compare_wrap">
        <section class="compare_left">
            ...
            <div id="event_list" class="srel_list srel_noneimg">
                <?php
                $sql = " select ev_id, ev_subject from {$g5['g5_shop_event_table']} where site_id = '$site_id' order by ev_id desc ";
                $result = sql_query($sql);
                for ($g=0; $row=sql_fetch_array($result); $g++) {
                    if($g == 0)
                        echo '<ul>';
