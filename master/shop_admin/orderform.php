    ...
    <section id="sodr_qty_log">
        ...
        <div>
            <table>
                ...
                <thead style="background:#6f809a;color:#fff;height:30px;line-height:30px;">
                <tr>
                    <th scope="col">CTI 주문번호</th>
                    <th scope="col">상품명</th>
                    <th scope="col">상태</th>
                </tr>
                </thead>
                <tbody>
                <?php
                $sql = " select * from {$g5['ribbon_table']} where od_id = '$od_id' ";
                $res = sql_query($sql);
                for($i=0; $ribbon=sql_fetch_array($res); $i++) {
                    if($ribbon['cti_option']) {
                        $cti_option = "옵션 : ".$ribbon['cti_option'];
                    }
                    ?>
                    <tr>
                        <td class="td_paybybig" style="width:150px;"><?php echo $ribbon['order_no']; ?></td>
                        <td class="td_paybybig"><?php echo $ribbon['it_name']; ?></td>
                        <td class="td_paybybig"><?php echo $ribbon['cti_status']; ?></td>
                    </tr>
                <?php } ?>
                </tbody>
            </table>
        ...
        <section id="anc_sodr_taker" class="compare_right">
            ...
            <div class="tbl_frm01">
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <input type="text" name="od_hope_date" value="<?php echo $od['od_hope_date']; ?>" id="od_hope_date" class="frm_input" maxlength="10" minlength="10"> (<?php echo get_yoil($od['od_hope_date']); ?>)
                        <select name="od_hope_time" id="od_hope_time" class="frm_input" >
                            <option value="">==선택하세요==</option>
                            <option value="09:00" <?if($od["od_hope_time"]=="09:00"){echo "selected";}?>>오전 9시</option>
                            <option value="09:30" <?if($od["od_hope_time"]=="09:30"){echo "selected";}?>>오전 9시 30분</option>
                            <option value="10:00" <?if($od["od_hope_time"]=="10:00"){echo "selected";}?>>오전 10시</option>
                            <option value="10:30" <?if($od["od_hope_time"]=="10:30"){echo "selected";}?>>오전 10시 30분</option>
                            <option value="11:00" <?if($od["od_hope_time"]=="11:00"){echo "selected";}?>>오전 11시</option>
                            <option value="11:30" <?if($od["od_hope_time"]=="11:30"){echo "selected";}?>>오전 11시 30분</option>
                            <option value="12:00" <?if($od["od_hope_time"]=="12:00"){echo "selected";}?>>오후 12시</option>
                            <option value="12:30" <?if($od["od_hope_time"]=="12:30"){echo "selected";}?>>오후 12시 30분</option>
                            <option value="13:00" <?if($od["od_hope_time"]=="13:00"){echo "selected";}?>>오후 1시</option>
                            <option value="13:30" <?if($od["od_hope_time"]=="13:30"){echo "selected";}?>>오후 1시 30분</option>
                            <option value="14:00" <?if($od["od_hope_time"]=="14:00"){echo "selected";}?>>오후 2시</option>
                            <option value="14:30" <?if($od["od_hope_time"]=="14:30"){echo "selected";}?>>오후 2시 30분</option>
                            <option value="15:00" <?if($od["od_hope_time"]=="15:00"){echo "selected";}?>>오후 3시</option>
                            <option value="15:30" <?if($od["od_hope_time"]=="15:30"){echo "selected";}?>>오후 3시 30분</option>
                            <option value="16:00" <?if($od["od_hope_time"]=="16:00"){echo "selected";}?>>오후 4시</option>
                            <option value="16:30" <?if($od["od_hope_time"]=="16:30"){echo "selected";}?>>오후 4시 30분</option>
                            <option value="17:00" <?if($od["od_hope_time"]=="17:00"){echo "selected";}?>>오후 5시</option>
                            <option value="17:30" <?if($od["od_hope_time"]=="17:30"){echo "selected";}?>>오후 5시 30분</option>
                            <option value="18:00" <?if($od["od_hope_time"]=="18:00"){echo "selected";}?>>오후 6시</option>
                            <option value="18:30" <?if($od["od_hope_time"]=="18:30"){echo "selected";}?>>오후 6시 30분</option>
                            <option value="19:00" <?if($od["od_hope_time"]=="19:00"){echo "selected";}?>>오후 7시</option>
                            <option value="19:30" <?if($od["od_hope_time"]=="19:30"){echo "selected";}?>>오후 7시 30분</option>
                            <option value="20:00" <?if($od["od_hope_time"]=="20:00"){echo "selected";}?>>오후 8시</option>
                            <option value="20:30" <?if($od["od_hope_time"]=="20:30"){echo "selected";}?>>오후 8시 30분</option>
                            <option value="21:00" <?if($od["od_hope_time"]=="21:00"){echo "selected";}?>>오후 9시</option>
                            <option value="21:30" <?if($od["od_hope_time"]=="21:30"){echo "selected";}?>>오후 9시 30분</option>
                            <option value="22:00" <?if($od["od_hope_time"]=="22:00"){echo "selected";}?>>오후 10시</option>
                        </select>
                        <input type="checkbox" name="od_hope_now" id="od_hope_now" value="<?php echo $od['od_hope_now']; ?>" <?php echo get_checked($od["od_hope_now"], '1'); ?>>
                        <label for="od_hope_now" style="color:red;">즉시배송</label>
                        <script>
                            if($("#od_hope_now").is(":checked") == true) {
                                $("input#od_hope_date").prop("disabled", true);
                                $("input#od_hope_date").css("background","#ccc");
                                $("select#od_hope_time").prop("disabled",  true);
                                $("select#od_hope_time").css("background","#ccc");
                                $("input#od_hope_date").val("");
                                $("select#od_hope_time").val("");
                            }

                            $(function () {
                                $("#od_hope_now").change (function () {
                                    var  st = this.checked;
                                    if (st) {
                                        $("input#od_hope_date").prop("disabled", true);
                                        $("input#od_hope_date").css("background","#ccc");
                                        ...
                                        $("input#od_hope_date").prop("disabled",  false);
                                        $("input#od_hope_date").css("background","none");
                                        $("select#od_hope_time").prop("disabled",  false);
                                        $("select#od_hope_time").css("background","none");
                                    }
                                });
                            });
                        </script>
                ...
                <?php } ?>
                <?php
                $sql = "select * from {$g5['ribbon_table']} where od_id = '$od_id' order by rb_no asc";
                $res = sql_query($sql);
                for($v=0; $cp=sql_fetch_array($res); $v++) {
                    $k = $v + 1;
                    ?>
                    <tr>
                        <th>리본/카드 메세지 <?php echo  $k; ?></th>
                        <td colspan="3">
                            <input type="hidden" name="ribbon[<?php echo $v; ?>]">
                            <input type="hidden" name="rb_no[<?php echo $v; ?>]" value="<?php echo $cp['rb_no']; ?>">
                            <input type="hidden" name="rb_id[<?php echo $v; ?>]" value="<?php echo $cp['rb_id']; ?>">
                            <input type="radio" id="ribbon_type_1[<?php echo $v; ?>]" name="ribbon_type[<?php echo $v; ?>]" <?php echo get_checked($cp["ribbon_type"], '0'); ?> value="0"> <label for="ribbon_type_1[<?php echo $v; ?>]">리본 메세지</label>
                            <input type="radio" id="ribbon_type_2[<?php echo $v; ?>]" name="ribbon_type[<?php echo $v; ?>]" <?php echo get_checked($cp["ribbon_type"], '1'); ?> value="1"> <label for="ribbon_type_2[<?php echo $v; ?>]">리본 / 축하카드 메세지</label>
                            <input name="rb_left_content[<?php echo $v; ?>]"  class="frm_input"  value="<?php echo $cp['rb_left_content']; ?>" style="width:400px;"> <span class="ribbon_left">리본 왼쪽</span><br />
                            <input name="rb_right_content[<?php echo $v; ?>]"  class="frm_input" value="<?php echo $cp['rb_right_content']; ?>"  style="width:400px;"> <span class="ribbon_right">리본 오른쪽</span><br />
                            <input type="text" name="card_msg[<?php echo $v; ?>]" value="<?php echo htmlspecialchars($cp['card_msg']); ?>" id="card_msg"  class="frm_input " style="width:400px;"> <span class="card_msg">카드메세지</span>
                        </td>
                    </tr>
                <?php } ?>
                <tr>
                    <th scope="row">영수증 요청</th>
                    <td colspan="3">
                        <input type="radio" id="od_receipt_type_1" name="od_receipt_type" value="세금계산서" <?php echo get_checked($od["od_receipt_type"], '세금계산서'); ?>> <label for="od_receipt_type_1">세금계산서</label>
                        <input type="radio" id="od_receipt_type_2" name="od_receipt_type" value="현금영수증(사업자)" <?php echo get_checked($od["od_receipt_type"], '현금영수증(사업자)'); ?>> <label for="od_receipt_type_2">현금영수증(사업자)</label>
                        <input type="radio" id="od_receipt_type_3" name="od_receipt_type" value="현금영수증(전화번호)" <?php echo get_checked($od["od_receipt_type"], '현금영수증(전화번호)'); ?>> <label for="od_receipt_type_3">현금영수증(전화번호)</label>
                        <input type="radio" id="od_receipt_type_4" name="od_receipt_type" value="간이영수증" <?php echo get_checked($od["od_receipt_type"], '간이영수증'); ?>> <label for="od_receipt_type_4">간이영수증</label>
                        <input type="radio" id="od_receipt_type_5" name="od_receipt_type" value="카드영수증" <?php echo get_checked($od["od_receipt_type"], '카드영수증'); ?>> <label for="od_receipt_type_5">카드영수증</label>
                    </td>
                </tr>
                <script>
                    $("#od_receipt_type_1").bind("click", function() {
                        $("#receipt_type2").hide();
                        $("#receipt_type1").show();
                    });
                    $("#od_receipt_type_2, #od_receipt_type_3").bind("click", function() {
                        $("#receipt_type1").hide();
                        $("#receipt_type2").show();
                    });
                    $("#od_receipt_type_4, #od_receipt_type_5").bind("click", function() {
                        $("#receipt_type1").hide();
                        $("#receipt_type2").hide();
                    });
                </script>
                <tr id="receipt_type1" style="display:none;">
                    <th scope="row">영수증 메모</th>
                    <td colspan="3">
                        <table class="cebox1">
                            <tr>
                                <th>사업자 번호</th>
                                <td colspan="3"><input type="text" id="od_receipt_saupja_no" name="od_receipt_saupja_no" value="<?php echo $od["od_receipt_saupja_no"]; ?>" class="frm_input"></td>
                            </tr>
                            <tr>
                                <th>회사명</th>
                                <td><input type="text" id="od_receipt_company_name" name="od_receipt_company_name" value="<?php echo $od["od_receipt_company_name"]; ?>" class="frm_input"></td>
                                <th>대표자명</th>
                                <td><input type="text" id="od_receipt_company_owner" name="od_receipt_company_owner" value="<?php echo $od["od_receipt_company_owner"]; ?>" class="frm_input"></td>
                            </tr>
                            <tr>
                                <th>주소</th>
                                <td colspan="3"><input type="text" id="od_receipt_company_addr" name="od_receipt_company_addr" value="<?php echo $od["od_receipt_company_addr"]; ?>" class="frm_input" size="45" /></td>
                            </tr>
                            <tr>
                                <th>업태</th>
                                <td><input type="text" id="od_receipt_company_uptae" name="od_receipt_company_uptae" value="<?php echo $od["od_receipt_company_uptae"]; ?>" class="frm_input" /></td>
                                <th>종목</th>
                                <td><input type="text" id="od_receipt_company_upjong" name="od_receipt_company_upjong" value="<?php echo $od["od_receipt_company_upjong"]; ?>" class="frm_input" /></td>
                            </tr>
                            <tr>
                                <th>이메일</th>
                                <td colspan="3"><input type="text" id="od_receipt_company_email" name="od_receipt_company_email" value="<?php echo $od["od_receipt_company_email"]; ?>" class="frm_input" size="35">
                                </td>
                            </tr>
                        </table>
                    </td>
                </tr>
                <tr id="receipt_type2" style="display:none;">
                    <th scope="row">영수증 메모</th>
                    <td colspan="3"><textarea name="od_receipt_memo" id="od_receipt_memo" placeholder="계산서, 영수증의 사업자번호 등 입력해주세요"><?php echo $od["od_receipt_memo"]; ?></textarea></td>
                </tr>


                <tr>
                    <th scope="row"><label for="od_delivery_gallery_type">배송사진요청여부</label></th>
                    <td colspan="3">
                        <input type="radio" id="od_delivery_gallery_type_1" name="od_delivery_gallery_type"  value="배송후" <?php echo get_checked($od["od_delivery_gallery_type"], '배송후'); ?>> <label for="od_delivery_gallery_type_1">배송후사진</label>
                        <input type="radio" id="od_delivery_gallery_type_2" name="od_delivery_gallery_type"  value="배송전" <?php echo get_checked($od["od_delivery_gallery_type"], '배송전'); ?>> <label for="od_delivery_gallery_type_2">배송전사진</label>
                        <input type="radio" id="od_delivery_gallery_type_3" name="od_delivery_gallery_type"  value="현장" <?php echo get_checked($od["od_delivery_gallery_type"], '현장'); ?>> <label for="od_delivery_gallery_type_3">현장사진</label>
                    </td>
                </tr>
                <tr>
