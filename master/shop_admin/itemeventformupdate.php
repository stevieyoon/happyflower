...
else if ($w == "u")
{
    $sql = " update {$g5['g5_shop_event_table']}
                $sql_common
              where ev_id = '$ev_id' and site_id = '$site_id' ";
    sql_query($sql);
}
else if ($w == "d")
{
    ...
    // 이벤트상품삭제
    $sql = " delete from {$g5['g5_shop_event_item_table']} where ev_id = '$ev_id' and site_id = '$site_id' ";
    sql_query($sql);

    $sql = " delete from {$g5['g5_shop_event_table']} where ev_id = '$ev_id' and site_id = '$site_id' ";
    sql_query($sql);
}
