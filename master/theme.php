...
if($config['cf_theme'] && !in_array($config['cf_theme'], $theme))
    sql_query(" update {$g5['config_table']} set cf_theme = '' where site_id = '{$config['site_id']}' ");

$g5['title'] = "테마설정";
include_once('./admin.head.php');
?>

<script src="<?php echo G5_MASTER_URL; ?>/theme.js"></script>
<div class="local_wr">
...
<ul id="theme_list">
    ...
    for($i=0; $i<$total_count; $i++) {
        ...
        if($info['screenshot'])
            ...
            $screenshot = '<img src="'.G5_MASTER_URL.'/img/theme_img.jpg" alt="">';
