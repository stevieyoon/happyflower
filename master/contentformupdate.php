...
if ($w == "" || $w == "u")
{
    ...
    $sql = " select * from {$g5['content_table']} where co_id = '$co_id' and site_id = '{$site_id}' ";
...
else if ($w == "d")
{
    ...
    $sql = " delete from {$g5['content_table']} where co_id = '$co_id' and site_id = '$site_id' ";
    sql_query($sql);
}

if(function_exists('get_master_captcha_by'))
    get_master_captcha_by('remove');
