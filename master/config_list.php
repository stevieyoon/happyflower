...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td headers="mb_list_mng" class="td_mng td_tel"><button type="button" class="tmli_dt theme_preview" data-cf_admin="<?php echo $row['cf_admin']; ?>">상세보기</button></td>
    </tr>
...
$(function() {
    $(".theme_preview").on("click", function () {
        var cf_admin = $(this).data("cf_admin");

        $("#order_detail").remove();

        $.ajax({
            type: "POST",
            url: "./shop_order_detail.php",
            data: {
                "cf_admin": cf_admin
            },
            cache: false,
